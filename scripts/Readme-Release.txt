...
* knx (OpenKNX KNX-Stack):    https://github.com/OpenKNX/knx
* OFM-ConfigTransfer:         https://github.com/OpenKNX/OFM-ConfigTransfer
* OFM-FileTransferModule:     https://github.com/OpenKNX/OFM-FileTransferModule
* OFM-FunctionBlocks          https://github.com/OpenKNX/OFM-FunctionBlocks
* OFM-Homematic:              https://github.com/OpenKNX/OFM-Homematic
* OFM-InternetWeatherModule:  https://github.com/OpenKNX/OFM-InternetWeatherModule
* OFM-LogicModule:            https://github.com/OpenKNX/OFM-LogicModule
* OFM-Network:                https://github.com/OpenKNX/OFM-Network
* OFM-UsbExchange:            https://github.com/OpenKNX/OFM-UsbExchange
* OGM-Common:                 https://github.com/OpenKNX/OGM-Common
* OGM-HardwareConfig:         https://github.com/OpenKNX/OGM-HardwareConfig
